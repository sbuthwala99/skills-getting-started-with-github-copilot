...
activities = {
    ...
    "Soccer Club": {
        "description": "Join our competitive soccer team for matches and training",
...
def remove_participant(activity_name: str, email: str = Query(..., description="Student email to remove")):
